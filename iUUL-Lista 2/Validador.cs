...
namespace iUUL_Lista_2
{
    ...
    public class Validador
    {
        ...
        public IDictionary<Enum, string> ValidarCliente(string nome, string cpf, string dataNasc, string rendaMensal, string estadoCivil, string dependentes)
        {
            ...
            if (nome.Length < 5)
            {
                erros.Add(ErrosClientes.NomeInvalido, "Erro no campo Nome: " + nome + 
                    "\nNome deve conter pelo menos 5 caracteres");
            }
            if (!long.TryParse(cpf, out long cpfValido) || cpf.Length != 11)
            {
                erros.Add(ErrosClientes.CpfInvalido, "Erro no campo CPF: " + cpf + 
            ...
            {
                erros.Add(ErrosClientes.DataNascInvalida, "Erro no campo Data de nascimento: " + dataNasc +
            ...
            {
                erros.Add(ErrosClientes.RendaMensalInvalida, "Erro no campo Renda mensal: " + rendaMensal +
            ...
            {
                erros.Add(ErrosClientes.EstadoCivilInvalido, "Erro no campo Estado civil: " + estadoCivil +
            ...
            {
                erros.Add(ErrosClientes.DependentesInvalido, "Erro no campo Dependentes: " + dependentes +
